...
using UnpaidCommission = PartnerCommissions.Wallets.Api.Domain.UnpaidCommission;

namespace PartnerCommissions.Wallets.Api.Infrastructure;

internal sealed class CommissionPayoutsGateway(CommissionPayouts.CommissionPayoutsClient client) : ICommissionPayouts
{
